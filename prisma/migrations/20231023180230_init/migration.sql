...
-- AddForeignKey
ALTER TABLE `Post` ADD CONSTRAINT `Post_favouritedBy_fkey` FOREIGN KEY (`favouritedBy`) REFERENCES `User`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
